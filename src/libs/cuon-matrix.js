...
export class Matrix4 {
    constructor(opt_src) {
        if (opt_src === null || opt_src === void 0 ? void 0 : opt_src.elements) {
   ...
   */
     ...
     * @return this
     */
    setLookAt(eyePos, centerPos, upPos) {
     ...
     * @return this
     */
    dropShadowDirectionally(normVec3, planeVec3, lightVec3) {
